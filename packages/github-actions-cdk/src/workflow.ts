...
export interface WorkflowProps {
  /**
   * An optional comment that can be included at the top of the generated workflow YAML.
...
export class Workflow extends Component {
  ...
  /**
   * The comment included at the top of the generated workflow YAML.
   */
  ...
  constructor(scope: IConstruct, id: string, props: WorkflowProps = {}) {
    ...
    this.commentAtTop =
      props.commentAtTop ?? "Generated by github-actions-cdk, DO NOT EDIT DIRECTLY!";
