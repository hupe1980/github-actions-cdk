import { decamelize, snakeCaseKeys, ensureDirSync, cleanObject } from '../../src/private/utils';
...
describe('snakeCaseKeys', () => {
    ...
    it('should handle nested objects', () => {
        ...
        const expected = { 'my-variable-name': { 'nested-key': 'value' }, 'another-key': 'anotherValue' };
        expect(snakeCaseKeys(input)).toEqual(expected);
    });
